        ...
        {isButtonClicked && (
          <div className="nav-item dropdown">
            <div className="row m-1">
              ...
              <Link className="m-2 responsive-item" to="/services">
                Services
              </Link>
              <Link className="m-2 responsive-item" to="/industries">
                Industries
              </Link>
            ...
            <ul className="navbar-nav mr-auto">
              ...
              <li className="nav-item dropdown">
                ...
                <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <Link className="dropdown-item" to="/paperless-microbiology">
                    Paper less microbiology
                  </Link>
                  <Link className="dropdown-item" to="/usfda-warning-letter-management">
                    {" "}
                    USFDA warning letter management
                  </Link>
                  <Link className="dropdown-item" to="/merger-and-acquisition">
                    Merger & acquisition
                  </Link>
                  <Link className="dropdown-item" to="/ai-assited-culture-of-quality">
                    {" "}
