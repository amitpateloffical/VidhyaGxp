...
export default function QMSSupport() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We provide comprehensive support for Quality Management
                    Systems, including system review, implementation,
                    investigations, risk management, supplier assessment,
                    management, API/formulation audits and certification.
                  </li>
