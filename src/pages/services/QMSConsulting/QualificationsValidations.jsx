...
export default function QualificationsValidations() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    "We offer comprehensive support for the qualification and
                    validation of facilities, equipment, systems, and utilities,
                    ensuring compliance with global regulatory standards. Our
                    services include risk management, detailed documentation and
                    reporting, and expert training and consultation, empowering
                    your team to maintain operational excellence."
                  </li>
