              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We offer specialized engineering design solutions tailored
                    to meet the unique needs of pharmaceutical processes. Our
                    services cover both greenfield and brownfield projects,
                    assisting clients in aligning with Quality by Design (QbD)
                    principles.
                  </li>
