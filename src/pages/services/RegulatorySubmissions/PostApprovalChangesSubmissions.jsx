...
export default function PostApprovalChangesSubmissions() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We manage post-approval changes submissions to regulatory
                    authorities, facilitating smooth updates and modifications.
                  </li>
