...
export default function InvestigationalNewDrug() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    For drugs under investigation, we support the preparation and submission of INDA to regulatory authorities.
                  </li>
