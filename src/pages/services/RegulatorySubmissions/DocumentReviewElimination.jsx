...
export default function DocumentReviewElimination() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our experts conduct thorough reviews of documents before
                    submission, ensuring completeness and accuracy to eliminate
                    potential queries or rejections from regulatory authorities.
                  </li>
