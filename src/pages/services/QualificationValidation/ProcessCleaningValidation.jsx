...
export default function ProcessCleaningValidation() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Additionally, we execute process validation and cleaning
                    validation as per specific regulatory and client demands.
                    Process validation is of utmost importance as it guarantees
                    consistent manufacturing processes that meet the desired
                    quality standards of the finished product. Our cleaning
                    validation procedures verify the effectiveness of cleaning
                    processes to prevent product batch contamination, ultimately
                    ensuring the highest levels of product safety and quality.
                  </li>
