...
export default function OperationQualification() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our qualification experts meticulously handle the
                    documentation and execution of OQ activities related to
                    equipment, facilities, utilities, or systems. The OQ test is
                    conducted to guarantee that everything functions within
                    operational limits and meets predetermined specifications.
                  </li>
