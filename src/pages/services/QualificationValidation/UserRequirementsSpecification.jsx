...
export default function UserRequirementsSpecification() {
              ...
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    ...
                    We meticulously prepare URS and/or functional specifications
                    for equipment, facilities, utilities, or systems through
                    rigorous Risk Assessment. Our goal is to mitigate any GMP
                    risks to an acceptable level, ensuring compliance and
                    safety.{" "}
                  </li>
