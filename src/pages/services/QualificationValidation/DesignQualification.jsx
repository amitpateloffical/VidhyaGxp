...
export default function DesignQualification() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our experienced team conducts thorough design qualification
                    reviews, meticulously verifying them against the User
                    Requirement Specification. We provide unwavering support to
                    our clients during the Commissioning approval process.
                  </li>
