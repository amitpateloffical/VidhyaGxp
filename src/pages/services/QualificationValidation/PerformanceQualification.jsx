...
export default function PerformanceQualification() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our qualified experts provide unwavering support for the
                    performance qualification of equipment, facilities,
                    utilities, or systems, meticulously following the life cycle
                    concept. We also implement a robust control strategy for
                    process validation, ensuring compliance with regulatory and
                    client requirements
                  </li>
