              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our expert team prepares comprehensive SOPs related to
                    operation, cleaning, preventive maintenance, and calibration
                    of components. These SOPs are then handed over to the site,
                    and we conduct training to ensure seamless GMP compliance,
                    cleaning, and adherence to safety procedures.
                  </li>
