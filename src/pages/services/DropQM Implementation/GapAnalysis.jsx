              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our experts perform detailed gap analysis of the client's
                    existing quality systems to identify areas where
                    improvements are needed to meet regulatory standards and
                    industry expectations. The results of this analysis guide
                    the development of targeted improvement plans.
                  </li>
