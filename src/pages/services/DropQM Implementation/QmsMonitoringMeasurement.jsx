...
export default function QmsMonitoringMeasurement() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We monitor the effectiveness of implemented processes and
                    procedures, measuring the performance of the QMS. Our
                    support helps the site to be continuously prepared for
                    regulatory inspections and fosters a culture of continuous
