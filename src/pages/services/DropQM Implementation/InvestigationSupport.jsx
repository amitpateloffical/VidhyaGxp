...
export default function InvestigationSupport() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our team provides support and prepares investigation reports
                    for non-conformities such as market complaints, deviations,
                    OOS, OOT, batch failures, and microbiological
                    investigations. We identify probable root causes with
                    scientific justification and propose suitable CAPAs.
                  </li>
