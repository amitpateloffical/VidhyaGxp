...
export default function DevelopingProceduresQms() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We prepare standard operating procedures for various
                    departments, including warehouse, quality control,
                    production, packing, quality assurance, and engineering. Our
                    SOPs cover handling of deviations, market complaints, out of
                    specification (OOS) and out of trend (OOT) incidents, change
                    control, root cause analysis, human error, CAPA, and other
                    non-conformities related to failures.
                  </li>
