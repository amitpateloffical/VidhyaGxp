              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We perform root cause analysis using tools such as
                    brainstorming, fishbone diagram, scattered diagram, control
                    chart, fault tree analysis, FMEA, and 5-Why analysis. Our
                    goal is to correctly identify and understand risks to the
                    product, enabling the implementation of appropriate CAPAs.
                  </li>
