...
export default function TrainingRegulatoryCompliance() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    This training covers regulatory requirements and changes in
                    different regions to ensure adherence to laws and
                    guidelines.
                  </li>
