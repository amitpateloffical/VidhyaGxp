...
export default function DataIntegrityTraining() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Ensures that employees understand the importance of data
                    integrity and maintain accurate and reliable records.
                  </li>
