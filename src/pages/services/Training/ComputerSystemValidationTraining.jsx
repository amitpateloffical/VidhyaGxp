...
export default function ComputerSystemValidationTraining() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    This training educates personnel on the validation of
                    computer systems used in the pharmaceutical industry.
                  </li>
