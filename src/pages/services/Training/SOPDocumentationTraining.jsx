...
export default function SOPDocumentationTraining() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Employees are trained on the creation, review, and adherence
                    to Standard Operating Procedures (SOPs) and documentation
                    practices.
                  </li>
