...
export default function ProductSpecificTraining() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Specific training on new product launches, drug
                    formulations, or medical devices is essential for employees
