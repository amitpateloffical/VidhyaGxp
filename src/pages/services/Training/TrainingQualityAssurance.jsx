...
export default function TrainingQualityAssurance() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Employees involved in quality control and assurance receive
                    training on testing methodologies, market complaints,
                    deviation handling, CAPA, OOT/OOS, data integrity, data
                    analysis, and adherence to quality standards.
                  </li>
