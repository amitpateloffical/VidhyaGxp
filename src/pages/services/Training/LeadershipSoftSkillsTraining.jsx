...
export default function LeadershipSoftSkillsTraining() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Management and leadership teams undergo training to enhance
                    their leadership skills and effective communication.
                  </li>
