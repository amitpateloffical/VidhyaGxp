...
export default function TrainingSafetyEnvironmental() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Employees are educated on safety protocols, handling
                    hazardous materials, and environmental protection measures.
                  </li>
