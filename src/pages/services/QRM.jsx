    ...
    <>
      <div className="top_container m-3">
        <div className="service_headigr">
          <h1 className="heading service-head-text">Quality Risk Management (QRM)</h1>
        </div>
            ...
            <div className="row g-5 align-items-center row-xm">
              <div className="col-lg-6 wow fadeIn p-side" data-wow-delay="0.1s">
                <div className="abouts" data-aos="fade-right">
                  <img className="img-fluid" src="https://images.unsplash.com/photo-1639772823849-6efbd173043c?q=80&w=1374&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" />
                </div>
              </div>
