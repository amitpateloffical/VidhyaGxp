              ...
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    ...
                    Oversee the entire project, coordinating with architects, contractors, equipment suppliers, and other stakeholders to ensure timely execution and cost-effective implementation.
                  </li>
