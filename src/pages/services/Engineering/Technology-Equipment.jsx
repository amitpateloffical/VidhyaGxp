...
export default function TechnologyEquipment() {
              ...
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    ...
                    Provide guidance on selecting the appropriate technology
                    platforms, machinery, and equipment for various
                    manufacturing processes, ensuring efficiency and compliance
