...
export default function CommissioningQualification() {
              ...
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    ...
                    Executing commissioning and qualification protocols to
                    verify facility, utilities, and equipment adherence to GMP
                    guidelines.
                  </li>
