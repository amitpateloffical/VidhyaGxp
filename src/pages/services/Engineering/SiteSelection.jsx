            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
              <div className="abouts" data-aos="fade-right">
                <img
                  ...
                  src="https://www.thedolphinpalace.com/wp-content/uploads/2018/07/map.jpg"
                />
              </div>
            </div>
              ...
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    ...
                    Help in identifying suitable locations for the
                    pharmaceutical facility, considering factors such as
                    infrastructure, proximity to suppliers, customers,
