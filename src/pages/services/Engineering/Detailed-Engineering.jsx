            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
              <div className="abouts" data-aos="fade-right">
                <img
                  ...
                  style={{ width: "100%" }}
                  src="https://www.dynamicme.com.au/ressources/images/972bf7d9f4cf.jpg"
                />
              </div>
            </div>
              ...
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    ...
                    Developing precise engineering drawings and specifications, including architectural, structural, mechanical, electrical, and plumbing plans.
                  </li>
