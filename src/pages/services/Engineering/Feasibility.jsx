      ...
      <div className="top_container m-3">
        ...
        <div className="paragraph_container">
          <p className="paragraph" data-aos="fade-down">
            ...
            intelligence with our pioneering  Feasibility Studies solutions. Stepping into the
            future, we offer more than just software; we provide a gateway to
            excellence in manufacturing processes. Our Feasibility Studies service is at the
            heart of this transformation, designed to elevate your operations to
            new heights of efficiency, compliance, and quality.
          </p>
        </div>
      </div>
          ...
          <div className="row g-5 align-items-center row-xm">
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
              <div className="abouts" data-aos="fade-right">
                ...
                style={{ width: "100%" }}
                  src="/benefits-of-feasibility-study.png"
                />
              </div>
            </div>
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              <h3 className="why_line" data-aos="fade-left">
                Why Choose VidyaGxP’s Feasibility Studies?
              </h3>
              <div className="content_container">
                <ul>
                  <li data-aos="fade-left" className=" fs-5">
                    {/* <b>Seamless Compliance:- </b> */}
                    Assess the viability of the project by conducting market
                    research, analyzing regulatory requirements, evaluating the
                    availability of resources, and considering financial
                    implications.
                  </li>
