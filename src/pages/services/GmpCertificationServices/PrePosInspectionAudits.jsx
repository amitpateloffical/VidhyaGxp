...
export default function PrePosInspectionAudits() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We conduct thorough audits to support regulatory compliance
                    before and after inspections, ensuring readiness for any
                    assessments.
                  </li>
