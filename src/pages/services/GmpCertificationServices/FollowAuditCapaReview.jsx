...
export default function FollowAuditCapaReview() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We perform follow-up audits and review Corrective and
                    Preventive Actions (CAPAs) to verify the effectiveness of
                    addressing regulatory observations and compliance status.
                  </li>
