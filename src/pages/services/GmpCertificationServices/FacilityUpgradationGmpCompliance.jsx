...
export default function FacilityUpgradationGmpCompliance() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We assist in upgrading existing facilities to meet GMP
                    compliance requirements, enhancing productivity and quality.
                  </li>
