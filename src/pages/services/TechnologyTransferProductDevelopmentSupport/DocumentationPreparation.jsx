...
export default function DocumentationPreparation() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our experts help in preparing all the necessary
                    documentation, including batch records, validation
                    protocols, and regulatory submissions, to streamline the
