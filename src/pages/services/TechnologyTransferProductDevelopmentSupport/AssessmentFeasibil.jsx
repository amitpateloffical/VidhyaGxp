...
export default function AssessmentFeasibil() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We conduct a comprehensive feasibility study to evaluate the
                    viability of technology transfer and product development,
                    considering factors like resources, capabilities, and
