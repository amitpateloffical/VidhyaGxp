...
export default function TechnologyTransferExecution() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our team supports the actual technology transfer process,
                    ensuring seamless integration of the product development
                    activities from one site to another.
                  </li>
