...
export default function ProjectManagementes() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our consultants offer project management expertise to
                    oversee and coordinate all aspects of technology transfer
                    and product development, ensuring timely execution and
                    delivery. Our proven methodologies and experienced team will
                    work with you every step of the way, helping you bring
                    innovative and high-quality products to the market
                    efficiently and compliantly. Contact us today to learn more
                    about how we can support your pharmaceutical endeavors.
                  </li>
