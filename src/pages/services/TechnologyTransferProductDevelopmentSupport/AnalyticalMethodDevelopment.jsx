...
export default function AnalyticalMethodDevelopment() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Our experts assist in developing and validating analytical
                    methods to ensure accurate testing and quality control
