    ...
    <>
      <div className="top_container m-3">
        <div className="service_headingr">
          <h1 className="heading service-head-text" data-aos="fade-down">Pharma Audit & Remediation</h1>
        </div>
            ...
            <div className="row g-5 align-items-center row-xm">
              <div className="col-lg-6 wow fadeIn p-side" data-wow-delay="0.1s">
                <div className="abouts" data-aos="fade-right">
                  <img className="img-fluid" src="https://cdn.pixabay.com/photo/2017/03/13/21/41/scientist-2141259_1280.jpg" />
                </div>
              </div>
