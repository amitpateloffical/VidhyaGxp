...
export default function MarketRegulatoryStrategy() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We provide strategic guidance to help you chart the optimal
                    pathway for your product, market, and regulatory approval.
                    Our experts analyze the regulatory landscape and market
                    requirements to develop a well-informed strategy for market
                    entry and expansion.
                  </li>
