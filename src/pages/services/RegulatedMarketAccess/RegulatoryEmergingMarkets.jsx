...
export default function RegulatoryEmergingMarkets() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    For companies looking to enter emerging markets, our
                    regulatory team offers tailored strategies to navigate the
                    unique regulatory requirements of these regions. We ensure
                    that your products meet the necessary standards for
                    successful market access in these dynamic markets.
                  </li>
