...
export default function RootCauseAudits() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Specialized audits are conducted to investigate process or
                    laboratory failures and identify Corrective and Preventive
                    Actions (CAPAs).
                  </li>
