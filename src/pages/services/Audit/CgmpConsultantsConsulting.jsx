...
export default function CgmpConsultantsConsulting() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We provide high-level strategic consulting on GMP compliance
                    to guide your organization in achieving regulatory
                    adherence.
                  </li>
