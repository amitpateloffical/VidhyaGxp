...
export default function GapAnalysisMockAudits() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We perform GAP analysis and mock audits to identify areas
                    for improvement and readiness for regulatory inspections.{" "}
                  </li>
