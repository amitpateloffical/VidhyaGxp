...
export default function GmpAuditsStartingMaterials() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    Thorough audits are conducted to ensure compliance with Good
                    Manufacturing Practices (GMP) for API and starting
                    materials.
                  </li>
