...
export default function ThirdPartyManufacturingExecution() {
              ...
              <div className="content_container ">
                <ul>
                  <li data-aos="fade-left" className=" fs-5 ">
                    ...
                    We assist in the identification and execution of third-party manufacturing for site and technological transfers of products, both API and formulation.
                  </li>
