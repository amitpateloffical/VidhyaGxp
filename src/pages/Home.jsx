                        ...
                        <div className="row g-5 pt-5 row-xm">
                            <div className="col-lg-6 align-self-center text-center text-lg-start mb-lg-5">
                                ...
                                <p className="text-light mb-4  animated slideInRight ">
                                    ...
                                    Solutions: Harness the Power of Artificial
                                    Intelligence to Optimize, Innovate, and
                    ...
                    <div className="container">
                        <div className="row g-5 align-items-center row-xm">
                            ...
                            >
                                ...
                                <p className="mb-2">
                                    Transforming Possibilities into Reality: At
                                    VidyaGxP, we specialize in making your
                                    business smarter through cutting-edge
                                    Artificial Intelligence.{" "}
                                </p>
                                <p className="mb-4">
                                    Our solutions seamlessly integrate with your
                                    operations, unlocking new levels of
                                    efficiency and innovation. With a commitment
                                    to excellence, we elevate your business to
                                    thrive in the ever-evolving digital
                                    landscape.
                                </p>
                    ...
                    <div className="container py-5">
                        <div className="row g-5 align-items-center row-xm">
                            ...
                            >
                                ...
                                <p className="mb-4">
                                    Tailored AI Services to Elevate Your
                                    Business Unlock the full potential of
                                    Artificial Intelligence with our tailored
                                    solutions at VidyaGxP. We offer dynamic and
                                    innovative services, seamlessly integrating
                                    AI into your operations. From intelligent
                                    automation to data-driven insights, our
                                    expertise ensures your business stays at the
                                        ...
                                        <div className="row g-4">
                                            ...
                                            >
                                                <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                                                    ...
                                                    <p>
                                                        Empower success with our
                                                        Machine Learning
                                                        solutions. From
                                                        predictive analytics to
                                                        intelligent insights, we
                                                        unleash innovation for
                                            ...
                                            >
                                                <div className="service-item d-flex flex-column justify-content-center text-center rounded">
                                                    ...
                                                    <p>
                                                        ...
                                                        discovery, our
                                                        innovative services pave
                                                        the way for
                                                        transformative learning
                                                        experiences and
                                                        groundbreaking research.
                                                        Elevate your journey in
                                ...
                                <div className="case-item position-relative overflow-hidden rounded mb-2">
                                    ...
                                    >
                                        ...
                                        <h5 className="lh-base text-white mb-3">
                                            ...
                                            System for process optimization and
                                            compliance."
                                        </h5>
                                        <span className="btn btn-square btn-primary">
                                            <FontAwesomeIcon
