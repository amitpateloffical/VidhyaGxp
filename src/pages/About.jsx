            ...
            <div className="col-lg-12 wow fadeIn" data-wow-delay="0.5s">
              ...
              <div className="paragraph_container ">
                <p className="paragraph fs-5 pt-2">
                  VidyaGxP is a leading global provider of GxP software
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              >
                <h5 className="ps_paragraph">
                  Contact VidyaGxP today to discover how our GxP
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <div className="paragraph_container" data-aos="fade-left">
                <p className="paragraph">
                  VidyaGxP is committed to providing the highest quality
        ...
        <div className="container">
          <div className="row g-5 align-items-center row-xm">
            ...
            <div className="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <div className="paragraph_container" data-aos="fade-left">
                <p className="paragraph">
                  At VidyaGxP, we empower the global pharmaceutical
        ...
        <div className="container">
          <div className="row g-5 align-items-center row-xm">
            ...
            >
              <div className="paragraph_container">
                <p className="paragraph">
                  Ultimately, at VidyaGxP, we believe in the power of
